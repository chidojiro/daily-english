...
import { MeaningByCategory } from '../../../components/meaningByCategory';
  ...
  return (
    <StyledWordOutZone>
      <PageHeader>
        ...
        <StyledDecisions>
          <Button type="default" danger>Failed</Button>
          <Button type="default">Show</Button>
          <Button type="primary" >Passed</Button>
        </StyledDecisions>
      </PageHeader>
      <StyledBackBtn><Button type="link" size="large" onClick={onBackClick} icon={<LeftOutlined />}>Back</Button></StyledBackBtn>
